...
access_key_id="${bamboo_aws_gaas_prod_access_key_id}"
secret_access_key="${bamboo_aws_gaas_prod_secret_access_key}"
aws_region="${bamboo_aws_default_region}"

pg_user="${bamboo_fitment_lambda_prod_pg_user}"
pg_password="${bamboo_fitment_lambda_prod_pg_password}"
...
b2capikey="${bamboo_fitment_lambda_prod_b2capikey}"
